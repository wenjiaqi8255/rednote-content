/**
 * Mobile Preview Route Redirect Tests (Simplified)
 *
 * TDD Approach: Verify preview redirect renders and triggers redirect
 *
...
import MobilePreviewRedirectPage from '../page';
...
describe('/mobile/preview/[id] route redirect', () => {
  ...
  it('should render loading spinner', () => {
    const { container } = render(
      <MobilePreviewRedirectPage params={Promise.resolve({ id: mockSessionId })} />
    );
  ...
  it('should trigger redirect to unified preview page', () => {
    render(
      <MobilePreviewRedirectPage params={Promise.resolve({ id: mockSessionId })} />
    );
    ...
    expect(mockReplace).toHaveBeenCalledWith(`/preview/${mockSessionId}`);
  });
});
